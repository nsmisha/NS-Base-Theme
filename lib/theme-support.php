...
if ( ! function_exists( 'neversettle_theme_support' ) ) :
	function neversettle_theme_support() {
		// Add language support: @link {https://codex.wordpress.org/Multilingual_WordPress}
		load_theme_textdomain( 'neversettle', get_template_directory() . '/languages' );
	...
	add_action( 'after_setup_theme', 'neversettle_theme_support' );
endif;
