...
if ( ! class_exists( 'neversettle_Protocol_Relative_Theme_Assets' ) ) :
	class neversettle_Protocol_Relative_Theme_Assets {
		/**
	...
	$neversettle_protocol_relative_theme_assets = new neversettle_Protocol_Relative_Theme_Assets;
endif;
